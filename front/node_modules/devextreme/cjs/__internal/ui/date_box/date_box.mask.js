...
class DateBoxMask extends _date_box.default {
    ...
    _toggleAmPm() {
        ...
        const indexOfCurrentValue = _default_date_names.default.getPeriodNames(this._formatPattern).indexOf(currentValue);
    ...
    _getActivePartValue(dateValue) {
        ...
        return (0, _type.isFunction)(getter) ? getter(date) : date[getter]()
    }
